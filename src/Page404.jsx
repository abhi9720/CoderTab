...
const Page404 = () => {
    return (
        <div className="bg-white flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="py-2 text-base text-gray-800 mb-10">Sorry about that! Please visit our hompage to get where you need to go.</p>
